...
import com.michael.dragon.db.DgQuestion;
import com.michael.dragon.db.DgRecord;
    ...
    public static int getIconOfImportance(int importance) {
        ...
        switch( importance ){
            ...
            case DgDBHelper.Mark.NORMAL:
                id = R.mipmap.ic_normal_important;
                break;
            case DgDBHelper.Mark.IMPORTANT:
                id = R.mipmap.ic_important;
                break;
            case DgDBHelper.Mark.VERY_IMPORTANT:
                id = R.mipmap.ic_middle_important;
                break;
            case DgDBHelper.Mark.EXTRA_VERY_IMPORTANT:
                id = R.mipmap.ic_extra_important;
                break;
        }
        return id;
    }
